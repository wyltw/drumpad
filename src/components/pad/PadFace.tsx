    ...
    <span
      className={cn(
        ...
        isDragActive
          ...
          : "-translate-y-1 bg-zinc-700 text-base text-white/50 transition duration-300 group-hover:-translate-y-1.5 group-hover:text-white group-active:translate-y-0 group-active:text-white",
