  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      >
        ...
        <span className="ring-primary/75 hover:animate-button-pulsing absolute top-3/6 left-3/6 block size-32 -translate-16 scale-100 rounded-2xl opacity-100 hover:ring-2"></span>
      </button>
